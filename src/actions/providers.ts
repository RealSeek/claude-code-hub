  ...
  try {
    ...
    const result = providers.map((provider) => {
      ...
      return {
        ...
        circuitBreakerRollingWindowDuration: provider.circuitBreakerRollingWindowDuration,
        circuitBreakerMinimumSamples: provider.circuitBreakerMinimumSamples,
        circuitBreakerFailureRateThreshold: provider.circuitBreakerFailureRateThreshold,
        circuitBreakerConsecutiveFailureThreshold: provider.circuitBreakerConsecutiveFailureThreshold,
        circuitBreakerHalfOpenMaxConcurrency: provider.circuitBreakerHalfOpenMaxConcurrency,
        circuitBreakerHalfOpenLeaseDuration: provider.circuitBreakerHalfOpenLeaseDuration,
        circuitBreakerBaseOpenDuration: provider.circuitBreakerBaseOpenDuration,
